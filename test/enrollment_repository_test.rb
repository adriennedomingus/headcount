...
class EnrollmentRepositoryTest < MiniTest::Test
  ...
  def test_loads_data
    ...
    result = {:name=>"ACADEMY 20", :kindergarten_participation=>{2010=>0.43628}, :high_school_graduation=>{}}
  ...
  def test_loads_two_data_files
    ...
    result = {:name=>"ACADEMY 20", :kindergarten_participation=>{2010=>0.43628}, :high_school_graduation=>{2010=>0.895, 2011=>0.895, 2012=>0.88983, 2013=>0.91373, 2014=>0.898}}
    assert_equal result, er.enrollment_objects[17].data
  end
  ...
  def test_find_by_name_with_two_files
    ...
    result = {:name=>"ADAMS-ARAPAHOE 28J", :kindergarten_participation=>{2007=>0.47359, 2006=>0.37013, 2005=>0.20176, 2004=>0.17444, 2008=>0.47965, 2009=>0.73, 2010=>0.92209, 2011=>0.95, 2012=>0.97359, 2013=>0.9767, 2014=>0.97123}, :high_school_graduation=>{2010=>0.455, 2011=>0.485, 2012=>0.47984, 2013=>0.52627, 2014=>0.559}}
