...
class HeadcountAnalystTest < MiniTest::Test
  ...
  #   skip
  #   assert_equal 1,  @ha.kindergarten_participation_correlates_with_high_school_graduation(for: "STATEWIDE")
  # end
  #
  ...
  #   assert_equal 0.603, @ha.high_poverty_and_high_school_graduation.matching_districts[4].free_and_reduced_price_lunch_rate
  #   assert @ha.high_poverty_and_high_school_graduation.is_a?(ResultSet)
  # end

  def test_high_income_disparity
    assert_equal 66295.2, @ha.high_income_disparity.matching_districts[1].median_household_income
