...
class StatewideTestTest < Minitest::Test
  ...
  def test_proficiency_by_race_or_ethnicity
    ...
    result1 = {2011=>{:math=>0.7065, :reading=>0.8513, :writing=>0.7401}, 2012=>{:math=>0.7135, :reading=>0.86189, :writing=>0.7262}, 2013=>{:math=>0.7208, :reading=>0.86083, :writing=>0.7406}, 2014=>{:math=>0.723, :reading=>0.00856, :writing=>0.7348}}
